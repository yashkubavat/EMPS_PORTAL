<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registration.aspx.cs" Inherits="EMPS_PORTAL.registration" %>
                ...
                <div class="login-container app">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" id="department" name="department" placeholder="Enter department" required>
                            ...
                            <br>
                            <asp:Button ID="Button1" class="login-btn" Style="color: white;" runat="server" Text="Register" OnClick="Button1_Click" />
