<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="employee.aspx.cs" Inherits="EMPS_PORTAL.employee" %>
                ...
                <div class="profile-content">
                    <div class="profile-card">
                        ...
                        <div class="profile-details">
                            ...
                            <div class="detail-group">
                                <label>Email</label>
                                <p id="userEmail">john.smith@company.com</p>
                            </div>
                            <div class="detail-group">
                                <label>Phone</label>
                                <p id="userPhone">+1 (555) 123-4567</p>
                            </div>
                            <div class="detail-group">
                                <label>Department</label>
                                <p id="userDepartment">Engineering</p>
                            </div>
                            <div class="detail-group">
                                <label>Position</label>
                                <p id="userPosition">Software Engineer</p>
                            </div>
                            <div class="detail-group">
                                <label>Joining Date</label>
                                <p id="userJoiningDate">January 15, 2023</p>
                            </div>
                            <div class="detail-group">
                                <label>Location</label>
                                <p id="userLocation">New York, NY</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-header">
                    ...
                    <div class="attendance-summary">
                        <div class="summary-item">
                            ...
                            <span class="summary-value" id="monthlyAttendance">22/25</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">This Week</span>
                            <span class="summary-value" id="weeklyAttendance">4/5</span>
                        </div>
                    </div>
                </div>
